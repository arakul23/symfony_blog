 ...
 */
final class Version20260527054417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog CHANGE description description VARCHAR(255) DEFAULT \'text\' NOT NULL');
    }
